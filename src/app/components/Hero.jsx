                        ...
                        <div className="flex items-center justify-between h-16 lg:h-20">
                            <div className="flex-shrink-0 inline-flex">
                                <a href="#" title="" className="flex">
                                    <Image className="w-auto h-10 ml-28 rounded-lg" src={logo} alt="" />
                                </a>
                                <p className='text-xl font-bold text-black ml-2 mt-2'>Aniga's Attire</p>
                            </div>
                        ...
                        <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                            <div>
                                ...
                                <div className="mt-10 sm:flex sm:items-center sm:space-x-8">
                                    <a href="#" title="" className="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 bg-orange-500 hover:bg-orange-600 focus:bg-orange-600" role="button"> Shop now </a>
                            ...
                            <div>
                                <Image className="w-4/6 ml-24" src={heroimg} alt="" />
                            </div>
                        </div>
                    </div>
                </section>
