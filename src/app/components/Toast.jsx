...
const Toast = ({ message, type = 'success', duration = 1000, onClose }) => {
  ...
  const getToastStyles = () => {
    ...
    switch (type) {
      ...
      default:
        return `${baseStyles} bg-gray-800 text-white translate-x-0 opacity-100`;
    }
  };
  ...
  return (
    <div className={getToastStyles()}>
      ...
      <button
        ...
        className="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 hover:bg-black hover:bg-opacity-20 focus:ring-2 focus:ring-gray-300 inline-flex h-8 w-8 text-white"
      >
