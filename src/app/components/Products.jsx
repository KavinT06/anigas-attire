...
import img3 from "../../assets/sgreen.jpg"
                    ...
                    <div className="grid grid-cols-2 gap-6 mt-10 lg:mt-16 lg:gap-4 lg:grid-cols-4">
                        <div className="relative group">
                            <div className="overflow-hidden aspect-w-1 aspect-h-1">
                                <Image className="object-cover w-4/5 h-full transition-all duration-300 group-hover:scale-125" src={img1} alt="" width="" height="" />
                            </div>
                        ...
                        <div className="relative group">
                            <div className="overflow-hidden aspect-w-1 aspect-h-1">
                                <Image className="object-cover w-4/5 h-full transition-all duration-300 group-hover:scale-125" src={img2} alt="" />
                            </div>
                            <div className="flex items-start justify-between mt-4 space-x-4">
                                <div>
                                    <h3 className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">
                        ...
                        <div className="relative group">
                            <div className="overflow-hidden aspect-w-1 aspect-h-1">
                                <Image className="object-cover w-4/5 h-full transition-all duration-300 group-hover:scale-125" src={img3} alt="" />
                            </div>
                            <div className="absolute left-3 top-3">
                        ...
                        <div className="relative group">
                            <div className="overflow-hidden aspect-w-1 aspect-h-1">
                                <Image className="object-cover w-4/5 h-full transition-all duration-300 group-hover:scale-125" src={img4} alt="" />
                            </div>
                            <div className="flex items-start justify-between mt-4 space-x-4">
                                <div>
                                    <h3 className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">
