                            ...
                            {products.map((product) => (
                                <div key={product.id} className="group relative block overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                                    ...
                                    {product.images && product.images.length > 0 ? (
                                        ...
                                        <div className="h-64 sm:h-72 w-full bg-gray-200 flex items-center justify-center">
                                            <div className="text-center">
                                    ...
                                    <div className="relative border border-gray-100 bg-white p-6">
                                        ...
                                        <div className="flex gap-3">
                                            <button
                                                ...
                                                className="flex-1 rounded-sm bg-orange-100 px-4 py-3 text-sm font-medium text-orange-900 transition hover:scale-105 hover:bg-orange-200"
                                            >
                                                Add to Cart
                                            </button>
                                            <button
                                                onClick={() => handleViewProduct(product.id)}
                                                className="flex-1 rounded-sm bg-orange-500 px-4 py-3 text-sm font-medium text-white transition hover:scale-105 hover:bg-orange-600"
                                            >
                                                Buy Now
                                            </button>
                                        </div>
